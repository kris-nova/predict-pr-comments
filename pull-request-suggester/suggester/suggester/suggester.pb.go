...
// source: suggester/suggester.protobuf
...
func init() {
	...
	proto.RegisterType((*FileNameLinePair)(nil), "suggester.service.FileNameLinePair")
}

func init() { proto.RegisterFile("suggester/suggester.protobuf", fileDescriptor_dba5aea5cd8f1899) }
...
var _ModelRequest_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "suggester/suggester.protobuf",
}
